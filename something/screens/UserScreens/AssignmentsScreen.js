...
const cardsArrayInfo = [{progress:0, assignmentName:'Quiz 1', className:'CS 350'}, {progress:.55, assignmentName:'Quiz 2', className:'CS 450'},
{progress:.86, assignmentName:'Quiz 3', className:'CS 340'}]

const renderCards = () =>{
    let output = []
    for (const element of cardsArrayInfo) output.push(<HomeAssignmentCard progress={element.progress} assignmentName={element.assignmentName} className={element.className}/>)
